...
"""Run Callwitness against a mock agent session and show what it caught.
    ...
    python examples/generate_traffic.py                    # throwaway, nothing kept
    python examples/generate_traffic.py --keep             # writes to your real store
    python examples/generate_traffic.py --keep --repeat 40 # enough traffic for `suggest`
...
def main(argv=None) -> int:
    ...
    with _home_dir(args.keep) as home:
        ...
        if args.keep:
            ...
            print("    python examples/generate_traffic.py --keep --repeat 40")
            print("    callwitness suggest")
    return 0
