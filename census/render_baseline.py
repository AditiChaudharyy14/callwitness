...
<section>
  ...
  <div class="note">
    <p><b>{{CALLS}} calls across {{CALLED}} servers, on one machine.</b> That is a small sample, and it is the weakest thing about this work. It is the only published measurement of delivered size that exists, which makes it the best number available and still a thin one.</p>
