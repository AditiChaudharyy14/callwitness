...
<section>
  ...
  <div class="note">
    ...
    <p>The full method, every server that failed and why, and the rule that decided which tools were safe to call: <a href="/research/">how the census was taken</a>.</p>
  </div>
</section>
...
<footer>
  <a href="/research/">how this was measured</a> &nbsp;&middot;&nbsp;
